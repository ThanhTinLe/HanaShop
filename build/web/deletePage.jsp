<%-- 
    Document   : deletePage
    Created on : Apr 13, 2021, 11:56:07 PM
    Author     : Ray Khum
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <font color="red" size ="5px">${requestScope.DELETED}</font>
            </div>
        </nav>
        ...
        <form action="MainController">
            <input type="submit" value="Delete" name="btnAction" onclick="return confirm('do you want to delete')"/>
            <table border="1" style="width: 100%; text-align: center">
                ...
                <tbody>
                    <c:forEach var="list" items="${sessionScope.LIST_DELETE}">
                        <tr>
                            <td><img src="${list.proImage}" alt="a" width="130" height="130"></td>
                            <td>${list.proName}</td>
                            <td>${list.proPrice}</td>
                            <td>${list.quantity}</td>
                            ...
                            <td>
                                <c:if test="${list.status eq true}">
                                    <input type="checkbox" name="txtCheckDelete" value="${list.proID}"/>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
        ...
        <div class="container">
            <div class="row" style="text-align: center;">
                ...
                <div class="col-md-4" style="font-size: 20px; ">
                    <c:forEach var="size" begin="1" end="${sessionScope.INDEX_DELETE}">
                        <form action="MainController" method="GET" style="display: inline">
                            <button name="btnAction" value="Delete Page">${size}</button>       
