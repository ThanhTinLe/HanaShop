    ...
    <body>
        ...
        <div id="create" align="center">
            <form action="MainController" method="GET" id="form">
                ...
                <c:set var="loi" value="${requestScope.CREATE_ERROR}"/>
                <div id="input">
                    <div class="input_item">    
                        <input type="text" name="txtName" placeholder="Name" value="${param.txtName}"><br>
                        <font color ="red" size="5%">${loi.proNameError}</font>
                    </div>
                    <div class="input_item">
                        <input type="number" step="0.1" name="txtPrice" placeholder="Price" value="${param.txtPrice}"><br>
                        <font color ="red" size="5%">${loi.proPriceError}</font>
                    </div>
                    <div class="input_item">
                        <input type="number" name="txtQuantity" placeholder="Quantity" value="${param.txtQuantity}"><br>
                        <font color ="red" size="5%">${loi.quantityError}</font>
                    </div>
                    <div class="input_item">
                        <input type="text" name="txtDescription" placeholder="Description" value="${param.txtDescription}"><br>
                        <font color ="red" size="5%">${loi.descriptionError}</font>
                    </div>
                    <div class="input_item">
                        <input type="text" name="txtImage" placeholder="Image Link" value="${param.txtImage}"><br>
                ...
                <div id="date">
                    <h4>Create Date: </h4>
                    <input type="date" name="createDate" readonly="true" id="createDate" value="${sessionScope.DATE}"><br>
                    <h4>Expiry Date: </h4>
                    <input type="date" name="expiryDate" value="${param.expiryDate}"><br>
                ...
                <button type="submit" class="btn btn-secondary" name="btnAction" value="Create">Create</button>
            </form>
        </div>
    </body>
</html>
